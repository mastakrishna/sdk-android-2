 ...
 * The Content Request
 */
public class ContentExample extends Activity
{
    /**
     * Unique name for logging
     */
    private static final String TAG = ContentExample.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        /**
         * Set our layout to src/main/android/res/layout/content.xml
         */
