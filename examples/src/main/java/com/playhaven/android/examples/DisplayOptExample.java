...
/**
 * The Content Request with Display Options
 */
public class DisplayOptExample extends Activity
{
    /**
     * Unique name for logging
     */
    private static final String TAG = DisplayOptExample.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        /**
         * Set our layout to src/main/android/res/layout/dispopt.xml
         */
        setContentView(R.layout.dispopt);
